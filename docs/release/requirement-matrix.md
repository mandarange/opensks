...
| 4 | The daemon is an explicit streaming service | PR-026, PR-028 | NDJSON daemon emits explicit `request_completed`; framed protocol v2 is not implemented | Foundation |
