...
| `image.generate` | Image generation | Degraded | Limited | no | `provider_image_lane_present_needs_enabled_image_route` | crate:opensks-image, crate:opensks-adapter, daemon:provider-image-tool-executor, schema:image-provenance-receipt |
| `image.inspect` | Image inspection | Degraded | Limited | no | `provider_vision_lane_present_needs_enabled_vision_route` | crate:opensks-image, crate:opensks-adapter, daemon:provider-image-tool-executor, schema:image-provenance-receipt |
